package com.sl.gtgx.common.config;
...
//	public static final String WeatherUrl = "http://t.weather.sojson.com/api/weather/city/101010100";  //北京天气
	...
	//下载地址
	public static final String DEV_DOWNURL="http://192.168.0.182:21112/";    //dev
	...
	//图片上传绝对路径
	public static final String DEV_UPLOAD="/data/www/15javadev_app_v3/gt/download/";    //dev
	...
	//index文件地址
	public static final String DEV_INDEX="/data/www/15javadev_app_v3/gt/download/appApk/index.html";    //dev
	...
	//二维码生成地址
	public static final String DEV_QRCODE="/data/www/15javadev_app_v3/gt/download/QrCode/";    //dev
	...
	public static final String PROD_PMP_IDRIP_URL = "http://gaoxin.ove-idrip.com/s2/";   //高新 171环境
