...
import com.sl.gtgx.app_1.entity.Support;
import com.sl.gtgx.app_1.service.SupportService_app1;
import com.sl.gtgx.common.config.UrlConfig;
import com.sl.gtgx.common.utils.CodeMsg1;
        ...
        if(total>0){
            ...
            for(Map<String,Object> result:results){
                ...
                if(Integer.parseInt((String)params.get("type"))==2){
                    ...
                    }else if(result.get("respond_staff")!=null&&((String)result.get("respond_staff")).contains((String)user.get("user_name"))){
