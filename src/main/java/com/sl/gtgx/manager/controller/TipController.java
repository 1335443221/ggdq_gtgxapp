...
import com.sl.gtgx.app_1.entity.Switchingroom;
...
import com.sl.gtgx.manager.entity.UserInfo;
import com.sl.gtgx.manager.service.Operation_logDataService;
import com.sl.gtgx.manager.service.SwitchingroomDataService;
import com.sl.gtgx.manager.service.TipDataService;
import com.sl.gtgx.common.utils.PageUtil;
import com.sl.gtgx.common.utils.QiniuUpload;
import com.sl.gtgx.common.utils.DownQrCode;
import com.sl.gtgx.common.utils.FileUtils;
...
public class TipController {
	...
	public String getTipById(Integer id,Model model){
		...
		model.addAttribute("prefix", UrlConfig.FILE_PREFIX);
		model.addAttribute("QiniuUrl", UrlConfig.QiniuUrl);
		return "gtgxPag/tipPag/updateTip";
	}
	...
	public String  getAllSwitchingroom(Model model,int pageindex,String key){
		...
		pageData.setParams(params);  //返回模糊查询信息
		model.addAttribute("page",pageData); 
		return "gtgxPag/switchingroomPag/showSwitchingroom";
	}
	...
	public String goAddSwitchingroom(String tid,Model model){
		...
		return "gtgxPag/switchingroomPag/addOrUpdateSwitchingroom";
	}
	...
	public String goQrCode(){
		return "gtgxPag/switchingroomPag/qrCode";
	}
